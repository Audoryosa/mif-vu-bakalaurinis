...
\section{„Mono2Micro“ praktinis pritaikymas}
...
Atlikus šiuos eksperimentus bus atlikta monolitinės sistemos migracija į „Mono2Micro“ parekomenduotus mikroservisus. Tada bus patikrinama, ar ši nauja sistema vis dar atlieka jai būdingus panaudos atvejus, bus lyginamas jos ir monolitinės sistemos našumas bei plečiamumas.
...
PLACEHOLDER Parasyt ar sudetingai buvo naudotis siuo irankiu is mano persperktyvos: dokumentacija, terminalo interfeisas, workbench supratimas, pasiulymai, rekomendacijos

\subsection{Patarimai ir rekomendacijos} % o gal \section{} ?
PLACEHOLDER ko tiketis naudojantis siuo irankiu, kaip paruosti appsa, ko nera dokumentacijoje, su kokiomis problemomis galima susidurti
